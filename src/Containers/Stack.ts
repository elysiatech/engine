...
export class Stack<T>
{
	 ...
	 */
	push(...elements: T[]) { this.#elements.push(...elements); }
	 ...
	 */
	*iterate() { while(this.#elements.length) yield this.#elements.pop(); }

	/**
	 * Iterates over the stack, not removing elements.
	 * @returns An iterator over the stack.
	 */
	*peekIterate() { for(const element of this.#elements) yield element; }
