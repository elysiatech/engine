...
(function (AudioEvent) {
    AudioEvent[AudioEvent["Load"] = 0] = "Load";
    AudioEvent[AudioEvent["Error"] = 1] = "Error";
    AudioEvent[AudioEvent["Play"] = 2] = "Play";
    AudioEvent[AudioEvent["Pause"] = 3] = "Pause";
    AudioEvent[AudioEvent["Stop"] = 4] = "Stop";
    AudioEvent[AudioEvent["Mute"] = 5] = "Mute";
    AudioEvent[AudioEvent["Unmute"] = 6] = "Unmute";
    AudioEvent[AudioEvent["Seek"] = 7] = "Seek";
...
export class Audio {
    ...
    clone() {
        if (!this.src && !this.buffer)
            throw new Error("Cannot clone an audio instance without a source or buffer");
