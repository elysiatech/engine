...
export class ElysiaTheme extends ElysiaElement {
    ...
    @attribute()
    accessor cullen = Colors.Cullen;
    @attribute()
    accessor nosferatu = Colors.Nosferatu;
    @attribute()
    accessor vonCount = Colors.VonCount;
    @attribute()
    accessor aro = Colors.Aro;
    @attribute()
    accessor red = Colors.Red;
    @attribute()
    accessor orange = Colors.Orange;
    @attribute()
    accessor yellow = Colors.Yellow;
    @attribute()
    accessor green = Colors.Green;
    @attribute()
    accessor purple = Colors.Purple;
    @attribute()
    accessor cyan = Colors.Cyan;
    @attribute()
    accessor pink = Colors.Pink;
    @attribute()
    accessor font = 'Kode Mono, sans';
    connectedCallback() {
