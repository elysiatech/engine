...
import { App, OnCreate, OnEnable, OnEnterScene, OnLoad, OnResize, OnUpdate, SceneLoadPromise } from "./Internal.js";
            ...
            */
            ...
            async loadScene(scene) {
                ...
                try {
                    ...
                    __classPrivateFieldGet(this, _Application_scene, "f")[Root][OnEnterScene]();
                    __classPrivateFieldGet(this, _Application_scene, "f")[Root][OnEnable]();
            ...
            update() {
                ...
                try {
                    ...
                    if (__classPrivateFieldGet(this, _Application_sizeHasChanged, "f")) {
                        __classPrivateFieldGet(this, _Application_scene, "f")[Root][OnResize](__classPrivateFieldGet(this, _Application_resizeController, "f").width, __classPrivateFieldGet(this, _Application_resizeController, "f").height);
                        __classPrivateFieldGet(this, _Application_renderPipeline, "f").onResize(__classPrivateFieldGet(this, _Application_resizeController, "f").width, __classPrivateFieldGet(this, _Application_resizeController, "f").height);
                        __classPrivateFieldSet(this, _Application_sizeHasChanged, false, "f");
                    }
                    // scene update
                    __classPrivateFieldGet(this, _Application_scene, "f")[OnUpdate](__classPrivateFieldGet(this, _Application_clock, "f").delta, __classPrivateFieldGet(this, _Application_clock, "f").elapsed);
                    // scene render
