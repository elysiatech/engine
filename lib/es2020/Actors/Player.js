...
import { ColliderBehavior, Colliders } from "../Physics/ColliderBehavior.js";
import { KeyCode } from "../Input/KeyCode.js";
import Rapier from "@dimforge/rapier3d-compat";
import * as Three from "three";
import { RigidBodyBehavior } from "../Physics/RigidBody.js";
import { PerspectiveCameraActor } from "./PerspectiveCameraActor.js";
import { ActiveCameraTag } from "../Core/Tags.js";
import { Behavior } from "../Scene/Behavior.js";
import { clamp } from "../Math/Other.js";
function applyFriction(vector, decel, maxVelocity, delta) {
...
class FPSController extends Behavior {
    ...
    constructor() {
        ...
        Object.defineProperty(this, "onMouseMove", {
            ...
            writable: true,
            value: (event) => {
                if (!this.enabled || !this.isLocked || !this.parent || !this.parent)
                    return;
        ...
        Object.defineProperty(this, "onPointerLockChange", {
            ...
            configurable: true,
            writable: true,
            value: (event) => this.isLocked = this.domElement?.ownerDocument.pointerLockElement === this.domElement
        });
        Object.defineProperty(this, "onPointerLockError", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: (event) => console.error(event)
        });
...
export class Player extends Actor {
    ...
    constructor() {
        ...
        Object.defineProperty(this, "inputVector", {
            enumerable: true,
            configurable: true,
            writable: true,
        ...
        Object.defineProperty(this, "desiredTranslation", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Three.Vector3(0, 0, 0)
        });
        Object.defineProperty(this, "computedTranslation", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Three.Vector3(0, 0, 0)
        ...
        Object.defineProperty(this, "rBody", {
            ...
            configurable: true,
            writable: true,
            value: new RigidBodyBehavior({ type: Rapier.RigidBodyType.KinematicVelocityBased })
        });
        Object.defineProperty(this, "rotationRoot", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Actor
        ...
        Object.defineProperty(this, "camera", {
            ...
            configurable: true,
            writable: true,
            value: new PerspectiveCameraActor
        });
    ...
    onCreate() {
        ...
        this.controller = this.scene.physics.getCharacterController(this.scene.physics.addCharacterController({ offset: 0.01 }));
    ...
    onBeforePhysicsUpdate(delta, elapsed) {
        if (!this.controller || !this.collider.collider)
            return;
        this.inputVector.set(0, 0, 0);
        if (this.isDown(KeyCode.S))
            this.inputVector.z += 1;
        if (this.isDown(KeyCode.W))
            this.inputVector.z -= 1;
        if (this.isDown(KeyCode.D))
            this.inputVector.x += 1;
        if (this.isDown(KeyCode.A))
            this.inputVector.x -= 1;
        ...
        this.controller.computeColliderMovement(this.collider.collider, this.desiredTranslation);
...
const isZero = (v) => Math.abs(v) < 0.00001;
