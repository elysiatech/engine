...
export class MeshTransmissionMaterial extends Three.MeshPhysicalMaterial {
    constructor({ samples = 6, transmissionSampler = false, chromaticAberration = 0.05, transmission = 0, _transmission = 1, transmissionMap = null, roughness = 0, thickness = 0, thicknessMap = null, attenuationDistance = Infinity, attenuationColor = new Three.Color('white'), anisotropicBlur = 0.1, time = 0, distortion = 0.0, distortionScale = 0.5, temporalDistortion = 0.0, buffer = null } = {}) {
        ...
        Object.defineProperty(this, "fboBack", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Three.WebGLRenderTarget(window.innerWidth, window.innerHeight, {
                minFilter: Three.LinearFilter,
                magFilter: Three.LinearFilter,
                type: Three.HalfFloatType,
            })
        });
        Object.defineProperty(this, "fboMain", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new Three.WebGLRenderTarget(window.innerWidth, window.innerHeight, {
        ...
        Object.defineProperty(this, "oldBg", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "oldTone", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "oldSide", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "mtmParams", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: {
        ...
        Object.defineProperty(this, "discardMat", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new DiscardMaterial
        });
        this.uniforms = {
    ...
    onUpdate(time, app, scene, mesh) {
        ...
        if (this.uniforms.buffer.value === this.fboMain.texture) {
            ...
            if (Array.isArray(mesh.material))
                this.oldSide = mesh.material[0].side;
            else
