...
class $87431ee93b037844$export$2489f9981ab0fa82 extends (0, $5Whe3$Pass1) {
    ...
    configureAOPass(logarithmicDepthBuffer = false, ortho = false) {
        ...
        if (this.effectShaderQuad) {
            ...
            this.effectShaderQuad = new (0, $e4ca8dcb0218f846$export$dcd670d73db751f5)(new $5Whe3$ShaderMaterial(e));
    }
    configureDenoisePass(logarithmicDepthBuffer = false, ortho = false) {
        ...
        if (this.poissonBlurQuad) {
            ...
            this.poissonBlurQuad = new (0, $e4ca8dcb0218f846$export$dcd670d73db751f5)(new $5Whe3$ShaderMaterial(p));
    }
    configureEffectCompositer(logarithmicDepthBuffer = false, ortho = false) {
        ...
        if (this.effectCompositerQuad) {
            ...
            this.effectCompositerQuad = new (0, $e4ca8dcb0218f846$export$dcd670d73db751f5)(new $5Whe3$ShaderMaterial(e));
    }
    /**
     *
     * @param {Number} n
