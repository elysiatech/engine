...
import { s_App, s_OnBeforePhysicsUpdate, s_OnCreate, s_OnEnable, s_OnEnterScene, s_OnLoad, s_OnResize, s_OnUpdate, s_SceneLoadPromise } from "../Scene/Internal.js";
...
let Application = (() => {
    ...
    return _a = class Application {
             ...
             * The active s_Scene.
            */
            get scene() { return __classPrivateFieldGet(this, _Application_scene, "f"); }
            ...
            constructor(config = {}) {
                ...
                */
                ...
                _Application_clock.set(this, new GameClock);
            ...
            async loadScene(scene) {
                ...
                try {
                    ...
                    if (__classPrivateFieldGet(this, _Application_scene, "f")) {
                        ELYSIA_LOGGER.debug("Unloading previous s_Scene", __classPrivateFieldGet(this, _Application_scene, "f"));
                        await __classPrivateFieldGet(this, _Application_scene, "f")[s_SceneLoadPromise];
                        __classPrivateFieldGet(this, _Application_scene, "f").destructor?.();
                        __classPrivateFieldSet(this, _Application_clock, new GameClock, "f");
                    }
                    await __classPrivateFieldGet(this, _Application_assets, "f")?.load();
                    scene[s_App] = this;
                    __classPrivateFieldSet(this, _Application_scene, scene, "f");
                    await __classPrivateFieldGet(this, _Application_scene, "f")[s_OnLoad]();
                    ...
                    __classPrivateFieldGet(this, _Application_scene, "f")[s_OnCreate]();
                    __classPrivateFieldGet(this, _Application_scene, "f")[Root][s_OnEnterScene]();
                    __classPrivateFieldGet(this, _Application_scene, "f")[Root][s_OnEnable]();
            ...
            destructor() {
                ...
                for (const prop of Object.values(this))
                    if (isDestroyable(prop))
                        prop.destructor();
                __classPrivateFieldGet(this, _Application_scene, "f")?.destructor();
                __classPrivateFieldGet(this, _Application_renderPipeline, "f")?.destructor();
                __classPrivateFieldGet(this, _Application_output, "f").remove();
            }
            ...
            update() {
                ...
                try {
                    ...
                    __classPrivateFieldGet(this, _Application_clock, "f").capture();
                    ...
                    if (__classPrivateFieldGet(this, _Application_stats, "f") instanceof ElysiaStats) {
                        ...
                        __classPrivateFieldGet(this, _Application_stats, "f").stats.fps = Math.round(1 / __classPrivateFieldGet(this, _Application_clock, "f").delta);
                    ...
                    if (__classPrivateFieldGet(this, _Application_sizeHasChanged, "f")) {
                        __classPrivateFieldGet(this, _Application_scene, "f")[Root][s_OnResize](__classPrivateFieldGet(this, _Application_resizeController, "f").width, __classPrivateFieldGet(this, _Application_resizeController, "f").height);
                        __classPrivateFieldGet(this, _Application_renderPipeline, "f").onResize(__classPrivateFieldGet(this, _Application_resizeController, "f").width, __classPrivateFieldGet(this, _Application_resizeController, "f").height);
                        __classPrivateFieldSet(this, _Application_sizeHasChanged, false, "f");
                    }
                    __classPrivateFieldGet(this, _Application_scene, "f")[s_OnBeforePhysicsUpdate](__classPrivateFieldGet(this, _Application_clock, "f").delta, __classPrivateFieldGet(this, _Application_clock, "f").elapsed);
                    // s_Scene update
                    __classPrivateFieldGet(this, _Application_scene, "f")[s_OnUpdate](__classPrivateFieldGet(this, _Application_clock, "f").delta, __classPrivateFieldGet(this, _Application_clock, "f").elapsed);
                    // s_Scene render
