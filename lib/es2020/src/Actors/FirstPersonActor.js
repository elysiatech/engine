...
import { CapsuleCollider } from "../Physics/Collider.js";
...
export class FirstPersonActor extends Actor {
    constructor() {
        ...
        Object.defineProperty(this, "collider", {
            ...
            configurable: true,
            writable: true,
            value: new CapsuleCollider(1, .5)
        });
        Object.defineProperty(this, "rBody", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: new RigidBody(RigidbodyType.KinematicVelocity)
        });
    ...
    onBeforePhysicsUpdate(delta, elapsed) {
        ...
        this.controller.computeColliderMovement(this.scene.physics.getCollider(this.collider), this.desiredTranslation);
