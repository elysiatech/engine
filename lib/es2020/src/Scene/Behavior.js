...
import { s_App, s_Created, s_Destroyed, s_Enabled, s_InScene, s_Internal, s_OnBeforePhysicsUpdate, s_OnCreate, s_OnDestroy, s_OnDisable, s_OnEnable, s_OnEnterScene, s_OnLeaveScene, s_OnReparent, s_OnResize, s_OnStart, s_OnUpdate, s_Parent, s_Scene, s_Started, s_Tags } from "./Internal.js";
...
export class Behavior {
    ...
    ************************************************************/
    ...
    [(_a = IsBehavior, _b = s_App, _c = s_Scene, _d = s_Parent, _e = s_Tags, _f = s_Enabled, _g = s_Internal, _h = s_Created, _j = s_Started, _k = s_InScene, _l = s_Destroyed, s_OnEnable)](force = false) {
