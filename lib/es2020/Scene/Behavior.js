...
let Behavior = (() => {
    ...
    return _a = class Behavior {
            ...
            ************************************************************/
            ...
            [(_b = IsBehavior, _c = (_onCreate_decorators = [bound], _onEnterScene_decorators = [bound], _onEnable_decorators = [bound], _onStart_decorators = [bound], _onBeforePhysicsUpdate_decorators = [bound], _onUpdate_decorators = [bound], _onDisable_decorators = [bound], _onLeaveScene_decorators = [bound], _onDestroy_decorators = [bound], _onReparent_decorators = [bound], _onResize_decorators = [bound], Internal), _member_decorators = [reportLifecycleError, bound], _d = __propKey(OnEnable))](force = false) {
            ...
            [(_member_decorators_3 = [reportLifecycleError, bound], _g = __propKey(OnEnterScene))]() {
            ...
            [(_member_decorators_4 = [reportLifecycleError, bound], _h = __propKey(OnStart))]() {
            ...
            [(_member_decorators_8 = [reportLifecycleError, bound], _m = __propKey(OnDestroy))]() {
                if (this[Internal].destroyed)
                    return;
                this.onDestroy();
                this[Internal].destroyed = true;
            }
            [(_member_decorators_9 = [reportLifecycleError, bound], _o = __propKey(OnReparent))](newParent) {
            ...
            [(_member_decorators_10 = [reportLifecycleError, bound], _p = __propKey(OnResize))](width, height) {
        ...
        (() => {
            ...
            __esDecorate(_a, null, _member_decorators_10, { kind: "method", name: _p, static: false, private: false, access: { has: obj => _p in obj, get: obj => obj[_p] }, metadata: _metadata }, null, _instanceExtraInitializers);
