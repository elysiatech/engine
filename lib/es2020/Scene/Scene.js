...
let Scene = (() => {
    ...
    return _a = class Scene extends _classSuper {
            ...
            getComponentsByTag(tag) {
                return __classPrivateFieldGet(this, _Scene_componentsByTag, "f").get(tag) || new ComponentSet;
            }
            /**
             * Returns all actors in the scene with the given type.
             */
            getComponentsByType(type) {
                return __classPrivateFieldGet(this, _Scene_componentsByType, "f").get(type) || new ComponentSet;
            }
            /**
