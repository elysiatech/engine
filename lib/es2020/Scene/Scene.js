...
let Scene = (() => {
    ...
    return _a = class Scene {
            ...
            [(_member_decorators_1 = [reportLifecycleError, bound], _j = __propKey(OnCreate))]() {
            ...
            [(_member_decorators_2 = [reportLifecycleError, bound], _k = __propKey(OnStart))]() {
            ...
            [(_member_decorators_3 = [reportLifecycleError, bound], _l = __propKey(OnBeforePhysicsUpdate))](delta, elapsed) {
            ...
            [(_member_decorators_4 = [reportLifecycleError, bound], _m = __propKey(OnUpdate))](delta, elapsed) {
                if (this[Internal].destroyed)
                    return;
                if (!this[Internal].started)
                    this[OnStart]();
            ...
            [(_member_decorators_5 = [reportLifecycleError, bound], _o = __propKey(OnDestroy))]() {
                if (this[Internal].destroyed)
                    return;
