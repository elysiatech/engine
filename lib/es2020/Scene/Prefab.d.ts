 ...
 */
export declare function definePrefab<Resources extends Record<string, any>, Arguments extends any[], Output>(resources: () => Resources, factory: (resources: Resources, ...restArgs: Arguments) => Output): (...args: Arguments) => Output;
