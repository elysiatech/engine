...
export class CubeActor extends MeshActor {
    ...
    constructor(color, position, rotation, scale) {
...
export class SphereActor extends MeshActor {
    get material() { return this.object3d.material; }
    constructor(color, position, radius = 1) {
...
export class CylinderActor extends MeshActor {
    ...
    constructor(color, position, radius = 1, height = 1) {
...
export class TorusActor extends MeshActor {
    ...
    constructor(color, position, radius = 1, tube = 0.4) {
