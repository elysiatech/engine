...
let RenderPipeline = (() => {
    ...
    return class RenderPipeline {
        static {
            ...
            __esDecorate(this, null, _onCameraChange_decorators, { kind: "method", name: "onCameraChange", static: false, private: false, access: { has: obj => "onCameraChange" in obj, get: obj => obj.onCameraChange }, metadata: _metadata }, null, _instanceExtraInitializers);
